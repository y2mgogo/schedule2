  ...
  render() {
    ...
    calendarData.forEach(function (e) {
      ...
      e.forEach(function (e) {
        ...
        var year = e.datejs.getFullYear();
        var month = e.datejs.getMonth() + 1 >= 10 ? e.datejs.getMonth() + 1 : "0" + (e.datejs.getMonth() + 1);
        var zeroDate = e.datejs.getDate() >= 10 ? e.datejs.getDate() : "0" + e.datejs.getDate();
        
        var day = $(`<span class="day-number">${e.date}</span><input type="hidden" value="`+ year + month + zeroDate + `" />`);
